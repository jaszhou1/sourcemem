...
ggplot(data=highdata,aes(x=highdata$response_error, ..density..)) + geom_histogram(bins = 50, color = "black", fill = "white")  +
  # ------ Model --------
  #Continuous
geom_line(data = mcontinuous_high_theta, aes(x = value, prob), size = 2, color = "dodgerblue3") +  
  facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") + 
  xlab("Theta (radians)") + 
  #Threshold
geom_line(data = mthreshold_high_theta, aes(x = value, prob), size = 2, color = "red") +  
  facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") + 
  xlab("Theta (radians)") + 
  #Hybrid
...
ggplot(data=highdata,aes(x=highdata$response_RT, ..density..)) + geom_histogram(bins = 50, color = "black", fill = "white")  +
  # ------ Model --------
  #Continuous
geom_line(data = mRT_continuous_high, aes(x = value, prob), size = 2, color = "dodgerblue3") +  
  facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") +
