...
plotThetaLow<-
# ------ Data ---------------------
ggplot(data = dlow_theta, aes(x = value, y = prob)) + 
  geom_point(size = 0.4) +
  # ------ Model --------
geom_line(data = mlow_theta, aes(x = value, prob), size = 0.5, colour = "red") +  
...
plotThetaHigh<-
# ------ Data ---------------------
ggplot(data = dhigh_theta, aes(x = value, y = prob)) + 
  geom_point(size = 0.4) +
  # ------ Model --------
geom_line(data = mhigh_theta, aes(x = value, prob), size = 0.5, colour = "red") +  
  facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 4, scale = "free") + 
  xlab("Theta (radians)") + 
  scale_x_continuous(name ="Response Error (radians)", # also x axis name 
                     breaks = c(-2, 0, 2),
...
plotRThigh<-
# ------ Data ---------------------
ggplot(data = dRT_high, aes(x = value, y = prob)) + 
  geom_point(size = 0.4) +
  # ------ Model --------
geom_line(data = mRT_high, aes(x = value, prob), size = 0.5, colour = "red") +  
  facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 4, scale = "free") + 
...
plotRTlow<-
# ------ Data ---------------------
ggplot(data = dRT_low, aes(x = value, y = prob)) + 
  geom_point(size = 0.4) +
  # ------ Model --------
geom_line(data = mRT_low, aes(x = value, prob), size = 0.5, colour = "red") +  
facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 4, scale = "free") + 
  xlab("Response Time (seconds)") + 
  ylab("Probability \n Density") + 
