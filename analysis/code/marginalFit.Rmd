...
plotThetaLow<-
# ------ Data ---------------------
ggplot(data=lowdata,aes(x=lowdata$response_error, ..density..)) + geom_histogram(bins = 75) +
  # ------ Model --------
...
plotThetaHigh<-
# ------ Data ---------------------
ggplot(data=highdata,aes(x=highdata$response_error, ..density..)) + geom_histogram(bins = 75) +
  # ------ Model --------
...
plotRThigh<-
# ------ Data ---------------------
ggplot(data=highdata,aes(x=highdata$response_RT, ..density..)) + geom_histogram(bins = 75)  +
  # ------ Model --------
...
plotRTlow<-
# ------ Data ---------------------
ggplot(data=lowdata,aes(x=lowdata$response_RT, ..density..)) + geom_histogram(bins = 75) +
  # ------ Model --------
