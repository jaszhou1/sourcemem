...
```{r}
setwd("~/GitHub/sourcemem/analysis/data/modelPredictions")
Mix <- read.csv("cumDist.csv", header = FALSE)
VP <- read.csv("VPcumDist.csv", header = FALSE)
time <- read.csv("timeDensity.csv", header = FALSE)
theta <- read.csv("thetaDensity.csv", header = FALSE)
```
