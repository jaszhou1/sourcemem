...
Cont <- read.csv('2020-01-15-19-48_Cont_Marginal_pooled.csv')
Thresh <- read.csv('2020-01-15-19-48_Thresh_Marginal_pooled.csv')
Hybrid <- read.csv('2020-01-15-19-48_Hybrid_Marginal_pooled.csv')
