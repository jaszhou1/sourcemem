...
```{r}
dataset <- read.csv('criterion_filtered.csv')
names(dataset)[1] <- "model_name"

continuous<- dataset[dataset$model_name == 'Continuous', ]
threshold<- dataset[dataset$model_name == 'Threshold', ]
hybrid<- dataset[dataset$model_name == 'Hybrid', ]
