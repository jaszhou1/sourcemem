...
dataset <- dataset[dataset$participant == participant, ]
...
Cont <- read.csv('2019-11-06_Crit_Cont.csv')
Thresh <- read.csv('2019-11-06_Crit_Thresh.csv')
Hybrid <- read.csv('2019-11-06_Crit_Hybrid.csv')
...
density <- density[density$participant == participant, ]
...
ggplot(data=lowdata,aes(x=lowdata$response_error, ..density..)) + geom_histogram(bins = 50, color="black", fill="white") +
  # ------ Model --------
  # Continuous
geom_line(data = mcontinuous_low_theta, aes(x = value, prob), size = 0.75, linetype = "dotted") +  
  facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") + 
  xlab("Response Error (radians)") + 
  
  # Threshold
  geom_line(data = mthreshold_low_theta, aes(x = value, prob), size = 0.75, linetype = "solid") +  
  facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") + 
  xlab("Response Error (radians)") +
  
  #Hybrid
  geom_line(data = mhybrid_low_theta, aes(x = value, prob), size = 0.75, linetype = "dotdash") +  
  facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") + 
  xlab("Response Error (radians)") +
...
plotThetaHigh1<-
# ------ Data ---------------------
ggplot(data=highdata,aes(x=highdata$response_error, ..density..)) + geom_histogram(bins = 50, color = "black", fill = "white")  +
  # ------ Model --------
  #Continuous
geom_line(data = mcontinuous_high_theta, aes(x = value, prob), size = 2, color = "blue") + facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") + 
  xlab("Theta (radians)") + 
  scale_x_continuous(name ="Response Error (radians)", # also x axis name 
                     breaks = c(-2, 0, 2),
                     labels = c(expression(-pi), "0", expression(pi))) + 
...
ggplot(data=highdata,aes(x=highdata$response_error, ..density..)) + geom_histogram(bins = 50, color = "black", fill = "white")  +
  # ------ Model --------
  #Continuous
geom_line(data = mcontinuous_high_theta, aes(x = value, prob), size = 2, color = "dodgerblue3") + facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") + 
  xlab("Theta (radians)") + 
  #Threshold
geom_line(data = mthreshold_high_theta, aes(x = value, prob), size = 2, color = "red") + facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") + 
  xlab("Theta (radians)") + 
  #Misc
  scale_x_continuous(name ="Response Error (radians)", # also x axis name 
                     breaks = c(-2, 0, 2),
...
geom_line(data = mthreshold_high_theta, aes(x = value, prob), size = 2, color = "red") + facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") + 
  xlab("Theta (radians)") + 
  #Hybrid
geom_line(data = mhybrid_high_theta, aes(x = value, prob), size = 2, color = "green4", linetype = "dashed") + facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") + 
  xlab("Theta (radians)") + 
  #Misc
  scale_x_continuous(name ="Response Error (radians)", # also x axis name 
                     breaks = c(-2, 0, 2),
...
plotRThigh1<-
# ------ Data ---------------------
ggplot(data=highdata,aes(x=highdata$response_RT, ..density..)) + geom_histogram(bins = 50, color = "black", fill = "white")  +
  # ------ Model --------
  #Continuous
geom_line(data = mRT_continuous_high, aes(x = value, prob), size = 2, color = "blue") +  
  facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") +
  #Misc
...
geom_line(data = mRT_continuous_high, aes(x = value, prob), size = 2, color = "blue") +  
  ...
  #Threshold
geom_line(data = mRT_threshold_high, aes(x = value, prob), size = 2, color = "red") +  
  facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") +
...
ggplot(data=highdata,aes(x=highdata$response_RT, ..density..)) + geom_histogram(bins = 50, color = "black", fill = "white")  +
  # ------ Model --------
  #Continuous
geom_line(data = mRT_continuous_high, aes(x = value, prob), size = 2.5, color = "blue") +  
  facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") +
  
  #Threshold
geom_line(data = mRT_threshold_high, aes(x = value, prob), size = 2.5, color = "red") +  
  facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") +

  #Hybrid
geom_line(data = mRT_hybrid_high, aes(x = value, prob), size = 2.5, color = "grey30", linetype = "dashed") +  
  facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") +
...
plotRTlow<-
# ------ Data ---------------------
ggplot(data=lowdata,aes(x=lowdata$response_RT, ..density..)) + geom_histogram(bins = 50, color = "black", fill = "white") +
  # ------ Model --------
  #Continuous
geom_line(data = mRT_continuous_low, aes(x = value, prob), size = 0.75, linetype = "dotted") +  
facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") +
  
  #Threshold
geom_line(data = mRT_threshold_low, aes(x = value, prob), size = 0.75, linetype = "solid") +  
facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") +
  #Hybrid
geom_line(data = mRT_hybrid_low, aes(x = value, prob), size = 0.75, linetype = "dotdash") +  
facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") +
  #Misc
  xlab("Response Time (seconds)") + 
  ylab("Probability \n Density") + 
