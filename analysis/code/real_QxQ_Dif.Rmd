...
cont <- read.csv("QQ_cont.csv")
thresh <- read.csv("QQ_thresh.csv")
hybrid <- read.csv("QQ_hybrid.csv")
...
# Plot continuous model           
  geom_line(data = cont,
            aes(x = cont$theta,
                y = cont$rt,
                group = cont$quantile_idx)) +
  
  # Plot threshold model           
  geom_line(data = thresh,
            aes(x = thresh$theta,
                y = thresh$rt,
                group = thresh$quantile_idx)) +
  
  # Plot hybrid model           
  geom_line(data = hybrid,
            aes(x = hybrid$theta,
                y = hybrid$rt,
                group = hybrid$quantile_idx)) +
