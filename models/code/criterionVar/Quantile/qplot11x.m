...
% ----------------------------------------------------------------------
    ...
    [ll,bic,Pred,Gstuff] = fitfunc(Pvar, Pfix, Sel, Data_in)
    ...
    axhandle =setfig3;
    qploti(co, axhandle(1), Data{1}, gtma, ta, thetaa, tmax, minrt, maxrt, 'Low');
    qploti(co, axhandle(2), Data{2}, gtmb, tb, thetab, tmax, minrt, maxrt, 'Med');
    qploti(co, axhandle(3), Data{3}, gtmc, tc, thetac, tmax, minrt, maxrt, 'High');
end

function qploti(co, axi, Datai, Gt, T, thetai, tmax, minrt, maxrt, labi)
% =======================================================================
