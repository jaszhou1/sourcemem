function qplotsrc(pred_mat, participant);
% ----------------------------------------------------------------------
% Empirical and RT fitted RT quantiles as a function of theta.
% for source memory experiment.
%       qplotsrc(@fitfunc, Pvar, Pfix, Sel, Data_in);
% ----------------------------------------------------------------------
    minrt = 0.15;  % Filter
    maxrt = 5.5;

    Data = pred_mat{participant, 6};
    Gstuff = pred_mat{participant, 5};
