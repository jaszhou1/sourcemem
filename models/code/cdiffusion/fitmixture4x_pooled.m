function [ll,bic,Pred, Gstuff, penalty, pest_penalty] = fitmixture4x_pooled(Pvar, Pfix, Sel, Data, nlow, nhigh, badix, trace)
% ========================================================================
...
eta1 = P(3);
eta2 = P(3);
a1 = P(4); % a1 and a2 remain separate because they are guessing and memory, not conditions
a2 = P(5);
pi1 = P(6);
pi2 = P(6);
ter = P(7);
...
Ub= [ 4.5, 4.5,  1,  5*ones(1,2),  1,   1.0, 0.8, 0];
Lb= [0, 0, 0,  0.3*ones(1,2), 0 , -0.5, 0, 0];

Pub=[ 4, 4, 0.7, 4.5*ones(1,2), 1,  0.8, 0.7, 0];
