function [ll, bic, Pred, pest, Gstuff, penalty] = FitVPMix(data, badix)
...
P(Sel==1) = pest;
[ll,bic,Pred, Gstuff, penalty] = fitmixture4x(P(Sel==1), P(Sel==0), Sel, data, nlow, nhigh, badix); %Criterion Range Error
%fitplot(D11, Pred);
end
