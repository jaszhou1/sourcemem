...
% Display the encode angle display.
encode_display_time = encode_display(screen, par, angle, false);

% Display the encoding word display.
word_display_time = encode_word(screen, par, word);
% 
...
while need_repeat
    ...
    % At 300ms (or whatever a frame is), was the position of the cursor
    % beyond a given distance radius of acceptable distance (sqrt(x,y))
end
