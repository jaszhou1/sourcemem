...
Hybrid <- read.csv('2019-11-06plot_NoCrit_Hybrid.csv')
...
geom_line(data = mcontinuous_low_theta, aes(x = value, prob), size = 0.75, colour = "red") +  
  ...
  #Hybrid
  geom_line(data = mhybrid_low_theta, aes(x = value, prob), size = 0.75, colour = "green2") +  
  facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") + 
  xlab("Response Error (radians)") +
...
geom_line(data = mthreshold_high_theta, aes(x = value, prob), size = 0.75, colour = "blue") +  
  ...
  xlab("Theta (radians)") + 
  #Hybrid
geom_line(data = mhybrid_high_theta, aes(x = value, prob), size = 0.75, colour = "green2") +  
  facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") + 
  xlab("Theta (radians)") + 
  #Misc
  scale_x_continuous(name ="Response Error (radians)", # also x axis name 
...
ggplot(data=lowdata,aes(x=lowdata$response_RT, ..density..)) + geom_histogram(bins = 50, color = "black", fill = "white") +
  # ------ Model --------
  #Continuous
geom_line(data = mRT_continuous_low, aes(x = value, prob), size = 0.75, color = "red") +  
facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") +
  
  #Threshold
geom_line(data = mRT_threshold_low, aes(x = value, prob), size = 0.75, linetype = "blue") +  
facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") +
  #Hybrid
geom_line(data = mRT_hybrid_low, aes(x = value, prob), size = 0.75, linetype = "green2") +  
facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") +
  #Misc
  xlab("Response Time (seconds)") + 
  ylab("Probability \n Density") + 
