...
library("tidyverse")
library(readr)
knitr::opts_knit$set(root.dir = "~/git/sourcemem/EXPIMG/models/figures/cDiffusionFits")
```

```{r}
data <- read.csv("QQ_data.csv")
cont <- read.csv("2020_02_10_19_28_pooled_cont4q.csv")
thresh <- read.csv("2020_02_10_19_28_pooled_cont4q.csv") 
hybrid <- read.csv("2020_02_10_19_28_pooled_cont4q.csv")
