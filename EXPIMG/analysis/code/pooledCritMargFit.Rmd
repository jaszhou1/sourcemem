...
ggplot(data=highdata,aes(x=highdata$response_error, ..density..)) + geom_histogram(bins = 50, color = "black", fill = "white")  +
  # ------ Model --------
  #Continuous
geom_line(data = mcontinuous_high_theta, aes(x = value, prob), size = 0.75, linetype = "dotted") +  
  facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") + 
  xlab("Theta (radians)") + 
  #Threshold
geom_line(data = mthreshold_high_theta, aes(x = value, prob), size = 0.75, linetype = "solid") +  
  facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") + 
  xlab("Theta (radians)") + 
  #Hybrid
...
ggplot(data=highdata,aes(x=highdata$response_RT, ..density..)) + geom_histogram(bins = 50, color = "black", fill = "white")  +
  # ------ Model --------
  #Continuous
geom_line(data = mRT_continuous_high, aes(x = value, prob), size = 0.75, linetype = "dotted") +  
  facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") +
  
  #Threshold
geom_line(data = mRT_threshold_high, aes(x = value, prob), size = 0.75, linetype = "solid") +  
  facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") +

  #Hybrid
geom_line(data = mRT_hybrid_high, aes(x = value, prob), size = 0.75, linetype = "dotdash") +  
  facet_wrap(~subjString, labeller = label_wrap_gen(width = 30), ncol = 3, scale = "free") +
