...
for i = 1:par.num_blocks
    % Run the encoding phase of the experiment.  
        ...
        for j = 1:num_encode_trials
            ...
            this_block_encode_data = [this_block_encode_data ...
                source_memory_encode_trial(scr, par, encode_word, encode_angle, encode_type, encode_cond)]; %new row for each trial
    ...
    % Run distractor task (30 seconds of Maths)
        ...
        this_block_maths_data = maths_distractor(scr, 5); %Change back to 30 if testing 
