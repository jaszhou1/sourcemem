function [] = param_avg_to_csv_confdrift(filename, Cont, Thresh, Hybrid)
...
header_line = 'model_name, v1a, v2a, v1b, v2b, eta, a, pi1, pi2, Ter, st, sa';
...
this_line = {'Thresh',...
    ...
    num2str(this_thresh(2)), num2str(0),...
    num2str(0),num2str(this_thresh(3)),...
...
this_line = {'Hybrid',...
    ...
    num2str(this_hybrid(2)), num2str(0),...
    num2str(this_hybrid(3)), num2str(this_hybrid(4)),...
    num2str(this_hybrid(5)), num2str(this_hybrid(6)),...
    num2str(this_hybrid(7)), num2str(this_hybrid(8)),...
    num2str(0)};
this_line = strjoin(this_line, ', ');
fprintf(fp, [this_line '\n']);
