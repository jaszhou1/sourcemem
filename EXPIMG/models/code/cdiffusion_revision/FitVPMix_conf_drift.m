function [ll, bic, Pred, pest, Gstuff, penalty, pest_penalty] = FitVPMix_conf_drift(data, badix)
...
P = [v1a, v2a, v1b, v2b, eta, a, pi1, pi2, Ter, st,sa];

Sel = [1,0,1,0,1,1,1,1,1,1,0];  
