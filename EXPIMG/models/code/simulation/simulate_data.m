...
nobvs = double.empty(20, 0);
for i = participants
    this_participant_nobvs = size(data{i,1}{1,1},1) + size(data{i,1}{1,2},1);
    nobvs(i) = this_participant_nobvs;
end
...
for i = participants
    ...
    simdata_cont{i,1} = this_sim;
end

%% Simulate the threshold model
simdata_thresh = cell(20,1);
for i = participants
    % Parameters of best fit of the continuous model to this participant
