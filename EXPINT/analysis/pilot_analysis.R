## The pilot experiment has no source component, I am just interested in finding the
## False Alarm and Hit Rate for the word lists
...
get.user.recognition <- function(p, s){
